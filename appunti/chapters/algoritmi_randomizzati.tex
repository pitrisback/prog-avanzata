...
L'idea di \emph{Stein} è proprio quella di fermare la contrazione dopo $k$ iterazioni (non compiendo quindi una \emph{full} contraction), andando a riutilizzare i grafi ottenuti all'inizio più volte.
