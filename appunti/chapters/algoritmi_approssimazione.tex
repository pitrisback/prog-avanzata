...
\begin{algorithm}[H]
\caption{Approssimatore per Triangle TSP}\label{alg:dnc}
\begin{algorithmic}[1]
...
L'idea è di partire da un $MST$ ed aggiungere archi in modo da rendere pari ogni nodo, e poi semplificare il cammino Euleriano trovato usando lo \emph{shortcutting}.
...
Arora ha mostrato nel 1998 \cite{Arora:1998:PTA:290179.290180} che $EUCLIDEAN\_TSP$ (la distanza per esempio è la norma 2) ammette un algoritmo PTAS,
per cui
$
\forall \varepsilon,
...
Papadimitriou e Vempala hanno mostrato nel 2006 \cite{Papadimitriou:2006:s00493-006-0008-z} che il $TRIANGLE\_TSP$ con archi simmetrici non può essere approssimato con un fattore migliore di 219/220.
