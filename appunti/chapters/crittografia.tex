...
\begin{proof}
    ...
    \end{equation*}
    In generale si è mostrato che $
    ab = dn
    $, e sostituendo ad $a$ e $b$ valgono
    \begin{equation*}
        dn = ab = (kd)b
        \quad
        dn = ab = a(hd)
    ...
    \begin{equation*}
        ...
        n = ha
    \end{equation*}
    Ovvero $n$ è multiplo di $a$ e $b$, ed è quindi un multiplo comune generico.
    Il minimo comune multiplo sarà allora di certo minore o uguale
    \begin{equation*}
        m \leq n
    \end{equation*}
    \\
