...
\begin{proof}
    ...
    Resta da verificare che se la stringa non appartiene al linguaggio, il verificatore non ritorna mai 1. Ed è vero perché se $x \notin L_1 \Rightarrow f(x) \notin L_2$ e quando la stringa non appartiene al linguaggio il verificatore ritorna sempre 0.
\end{proof}
