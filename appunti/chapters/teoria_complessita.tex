...
\begin{equation*}
    L_{\bpi{}_{C}} = \left\{ x \in \left\{ 0,1 \right\}^* : A_{\bpi{}_{C}}(x) = 1 \right\}
\end{equation*}
...
\begin{definition}
    ...
    \begin{align*}
        \bp{} &= \left\{ L \subseteq \left\{ 0,1 \right\}^* |\, L \text{ è deciso in tempo polinomiale}\right\} \\
        &= \left\{ \bpi{}_{C} : \left\{ 0,1 \right\}^* \to \left\{ 0,1 \right\} |\, \bpi{}_C \text{ è risolto in tempo polinomiale} \right\}
    \end{align*}
\end{definition}
...
\begin{definition}[Linguaggio verificato]
    ...
    \begin{equation*}
        L_V = \left\{ \bar{x} \in \left\{ 0,1 \right\}^* \text{ verificate da } V(x,y) \right\}
    \end{equation*}
\end{definition}
...
\begin{definition}
    ...
    \begin{equation*}
        \bnp{} = \left\{ L \subseteq \left\{ 0,1 \right\}^* \to \left\{ 0,1 \right\}|\, L \text{ è verificato in tempo polinomiale}\right\}
    \end{equation*}
\end{definition}
...
\begin{theorem}[Relazione d'ordine]
    ...
    Siano $L_1, L_2 \subseteq \left\{ 0,1 \right\}^{*}$, la relazione d'ordine fra linguaggi è indicata da
    \begin{equation*}
...
\begin{definition}[NP-hard]
    \label{def:nphard}
    Un linguaggio $L \subseteq \left\{ 0,1 \right\}^{*}$ si dice NP-hard se
    \begin{equation*}
...
\begin{definition}[NP-completo]
    \label{def:nphard}
    Un linguaggio $L \subseteq \left\{ 0,1 \right\}^{*}$ si dice NP-completo se
    \begin{align*}
        L & \in \bnp \\
        L & \in \bnph
    \end{align*}
...
Assegnando dei valori di verità $\vec{b} \in \left\{ 0,1 \right\}^{k}$ agli input di un circuito, si dice che questo \textit{commuta}, ossia assume una certa configurazione di valori su ogni filo, che si indica
\begin{equation*}
    Config(C) = \vec{h} \in \left\{ 0,1 \right\}^{m}
\end{equation*}

Un circuito di dice \textit{soddisfacibile} se
\begin{equation*}
    \exists \,\vec{b} \in \left\{ 0,1 \right\}^{k} : C ( \, \vec{b} \,) = 1
\end{equation*}
